...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
disp("Step 2: Downloading MagEIS data.")
...
tic
[TRBEC_rbspa,epoch_rbspa] = TRBEC_energy_pitch_angle_wrapper(flux_directory,DC_directory,epoch_start,epoch_stop,'rbspa',energy_min,energy_max,Lstar_min,Lstar_max);
[TRBEC_rbspb,epoch_rbspb] = TRBEC_energy_pitch_angle_wrapper(flux_directory,DC_directory,epoch_start,epoch_stop,'rbspb',energy_min,energy_max,Lstar_min,Lstar_max);
toc
